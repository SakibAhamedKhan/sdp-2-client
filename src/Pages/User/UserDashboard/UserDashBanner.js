					...
					<div class="form-control">
						<div class="input-group">
							<form onSubmit={handleSearch}>
								<input  name='search' type="text" placeholder="Enter Police Range ID..." class="input input-bordered w-96 text-xl text-black" required />
								<button type='submit' class="btn btn-square btn-primary text-white w-16">
